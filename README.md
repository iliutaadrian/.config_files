...
| `cheat`             | Searchable cheatsheet of all shortcuts  |
...
![Shortcuts Cheatsheet](screenshots/cheatsheet.png)

A single searchable view of every custom shortcut --
tmux keybindings, ZSH aliases, and functions --
generated by `scripts/cheatsheet.sh`.

Open it with `cheat` in the shell,
or `prefix + ?` for an 80% tmux popup:
